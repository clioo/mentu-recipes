...
verify a release, together with the real transcript from the `v0.2.0`
...
```sh
curl -sLO https://github.com/mentu-ai/mentu-recipes/releases/download/v0.2.0/mentu-recipes-macos-arm64
curl -sLO https://github.com/mentu-ai/mentu-recipes/releases/download/v0.2.0/checksums.txt
...
build signer:       .github/workflows/release.yml@refs/tags/v0.2.0
subject sha256:     1c3d0cf8c291ee43528d26ea3e7cc3fd5c08658ef2853f0ae306b99968f8fbba
exit code:          0
```
